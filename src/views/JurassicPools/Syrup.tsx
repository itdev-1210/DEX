...
import { useJurassicPools, useBlock } from 'state/hooks'
...
const Farm: React.FC = () => {
  ...
  const pools = useJurassicPools(account)
  ...
  return (
    <BackgroundContainer dark={isDark} bgimage={ isDark ? "/images/bgdarkjurassic.jpg" : "/images/bglightjurassic.jpg" } bgPos={ selectedSidebar ? 'calc(50% - 120px) 100px' : 'calc(50% - 23px) 100px'}>
      <Page>
